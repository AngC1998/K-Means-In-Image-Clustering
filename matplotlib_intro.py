...
def prob1():
    ...
    """
    input = np.array([100, 200, 300, 400, 500, 600, 700, 800, 900, 1000])
    output = []
    for i in range(0, len(input)):
        output.append(var_of_means(input.get(i)))
...
def prob4():
    ...
    ax3.set_title("Graph Three")
    
    ax4 = plt.subplot(224)
    ax4.plot(x, 2 * np.sin(2 * x), 'm:')
    ax4.set_title("Graph Four")
    
    plt.suptitle("Graphs of Problem 4")
